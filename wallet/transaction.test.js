...
describe("Transaction", () => {
  ...
  describe("update()", () => {
    ...
    describe("and the amount is invalid", () => {
      it("throws an error", () => {
        ...
        }).toThrow("amount axceeds balance");
      });
    });
      ...
      describe("and another update for the same recipient", () => {
        ...
        it("add to the recipient amount", () => {
          expect(transaction.outputMap[nextRecipient]).toEqual(
            nextAmount + addAmount
          );
        });

        it("subtracts the ammount from the original sender output amount", () => {
          expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
            originalSenderOutput - nextAmount - addAmount
          );
        });
      });
    });
  ...
  describe("rewardTransaction()", () => {
    ...
    it("creates transaction with the reward input", () => {
